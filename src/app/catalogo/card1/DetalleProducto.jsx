...
<nav>
  ...
  <div className="modal-overlay">
    <div className="modal-content">
      ...
      <center><button onClick={() => setModalOpen(false)}>Cerrar</button></center>
    </div>
  </div>
)}
  ...
  <svg className="svg-icon2" viewBox="0 0 20 20">
    ...
    <path d="M13.972,12.386c-1.022,0-1.855,0.834-1.855,1.856s0.833,1.853,1.855,1.853s1.854-0.83,1.854-1.853S14.994,12.386,13.972,12.386z M13.972,15.116c-0.484,0-0.878-0.393-0.878-0.874c0-0.484,0.394-0.878,0.878-0.878c0.482,0,0.875,0.394,0.875,0.878C14.847,14.724,14.454,15.116,13.972,15.116z"></path>
      ...
      <Image
            src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRucp-XKZKSoTcMfYG9DXeVIaq3fgOOY93mhAnGn02JiOCX2IK-rMslFyPFwTg7v2Fnl5o&usqp=CAU"}
            alt={`Imagen de camisa negra`}
            width={500}
            height={500}
          />
      </div>
